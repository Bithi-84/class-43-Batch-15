...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" placeholder="Enter student Email" name="email" id="email" value="" required>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" placeholder="Enter student class" name="class" id="class" value="" required>
